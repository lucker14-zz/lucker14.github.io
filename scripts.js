...
let config = {
    apiKey: "AIzaSyCmMTFXVer9B2QcnWBk9VNiaTFoO7_pY5k",
    authDomain: "utipem.firebaseapp.com",
    databaseURL: "https://utipem.firebaseio.com",
    projectId: "utipem",
    storageBucket: "utipem.appspot.com",
    messagingSenderId: "90348541015"
};

const email = firebase.initializeApp(config);
const database = email.database();
